...
var arrOfObj = [{ weight: 63, ftp: 250, elapsed_time: 7200, weighted_average_watts: 240, tssScore: null }, { weight: 63.1, ftp: 251, elapsed_time: 39719, weighted_average_watts: 168, tssScore: null }, { weight: 63.2, ftp: 252, elapsed_time: 35547, weighted_average_watts: 156, tssScore: null }, { weight: 63.3, ftp: 253, elapsed_time: 29377, weighted_average_watts: 205, tssScore: null }, { weight: 63.4, ftp: 254, elapsed_time: 11685, weighted_average_watts: 207, tssScore: null }, { weight: 63.5, ftp: 255, elapsed_time: 3521, weighted_average_watts: 227, tssScore: null }];
...
describe('calcTssScore', function () {
  test('(arrOfObj[0].elapsed_time, arrOfObj[0].weighted_average_watts arrOfObj[0].ftp) - (user elevation of 25) ', function () {
    expect(justFns.calcTssScore(arrOfObj[0].elapsed_time, arrOfObj[0].weighted_average_watts, arrOfObj[0].ftp)).toEqual(184.32);
  });
  test('(justFns.calcTssScore(arrOfObj[1].elapsed_time, arrOfObj[1].weighted_average_watts, arrOfObj[1].ftp) (user elevation of 25) ', function () {
...
describe('calcTssScoreRound', function () {
  test('(arrOfObj[0].elapsed_time, arrOfObj[0].weighted_average_watts arrOfObj[0].ftp) - defaults to 0 places > 184', function () {
    expect(justFns.calcTssScoreRound(arrOfObj[0].elapsed_time, arrOfObj[0].weighted_average_watts, arrOfObj[0].ftp)).toEqual(184);
  });
  test('(arrOfObj[1].elapsed_time, arrOfObj[1].weighted_average_watts, arrOfObj[1].ftp, 2) - set to 2 places > 494.27', function () {
